...
use bilrost_types::{field_descriptor_proto, DescriptorProto, FileDescriptorProto};
...
impl MessageGraph {
    ...
    /// Because bilrost does not box message fields, recursively nested messages would not compile in Rust.
