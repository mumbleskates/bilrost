...
impl ExternPaths {
    pub fn new(paths: &[(String, String)], bilrost_types: bool) -> Result<ExternPaths, String> {
        ...
        if bilrost_types {
            ...
            extern_paths.insert(
                ...
                "::bilrost::alloc::string::String".to_string(),
            )?;
            extern_paths.insert(
...
mod tests {
    ...
    fn test_well_known_types() {
        ...
        case(".google.protobuf.Value", "::bilrost_types::Value");
        case(".google.protobuf.Duration", "::bilrost_types::Duration");
