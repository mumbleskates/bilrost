...
pub struct FileDescriptorSet {
    ...
    pub file: ::bilrost::alloc::vec::Vec<FileDescriptorProto>,
}
...
pub struct FileDescriptorProto {
    ...
    #[bilrost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    /// e.g. "foo", "foo.bar", etc.
    #[bilrost(string, optional, tag = "2")]
    pub package: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Names of files imported by this file.
    #[bilrost(string, repeated, tag = "3")]
    pub dependency: ::bilrost::alloc::vec::Vec<::bilrost::alloc::string::String>,
    /// Indexes of the public imported files in the dependency list above.
    #[bilrost(int32, repeated, packed = "false", tag = "10")]
    pub public_dependency: ::bilrost::alloc::vec::Vec<i32>,
    /// Indexes of the weak imported files in the dependency list.
    /// For Google-internal migration only. Do not use.
    #[bilrost(int32, repeated, packed = "false", tag = "11")]
    pub weak_dependency: ::bilrost::alloc::vec::Vec<i32>,
    /// All top-level definitions in this file.
    #[bilrost(message, repeated, tag = "4")]
    pub message_type: ::bilrost::alloc::vec::Vec<DescriptorProto>,
    #[bilrost(message, repeated, tag = "5")]
    pub enum_type: ::bilrost::alloc::vec::Vec<EnumDescriptorProto>,
    #[bilrost(message, repeated, tag = "6")]
    pub service: ::bilrost::alloc::vec::Vec<ServiceDescriptorProto>,
    #[bilrost(message, repeated, tag = "7")]
    pub extension: ::bilrost::alloc::vec::Vec<FieldDescriptorProto>,
    #[bilrost(message, optional, tag = "8")]
    pub options: ::core::option::Option<FileOptions>,
    /// This field contains optional information about the original source code.
    /// You may safely remove this entire field without harming runtime
    /// functionality of the descriptors -- the information is needed only by
    /// development tools.
    #[bilrost(message, optional, tag = "9")]
    pub source_code_info: ::core::option::Option<SourceCodeInfo>,
    /// The syntax of the proto file.
    /// The supported values are "proto2" and "proto3".
    #[bilrost(string, optional, tag = "12")]
    pub syntax: ::core::option::Option<::bilrost::alloc::string::String>,
}
...
pub struct DescriptorProto {
    #[bilrost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, repeated, tag = "2")]
    pub field: ::bilrost::alloc::vec::Vec<FieldDescriptorProto>,
    #[bilrost(message, repeated, tag = "6")]
    pub extension: ::bilrost::alloc::vec::Vec<FieldDescriptorProto>,
    #[bilrost(message, repeated, tag = "3")]
    pub nested_type: ::bilrost::alloc::vec::Vec<DescriptorProto>,
    #[bilrost(message, repeated, tag = "4")]
    pub enum_type: ::bilrost::alloc::vec::Vec<EnumDescriptorProto>,
    #[bilrost(message, repeated, tag = "5")]
    pub extension_range: ::bilrost::alloc::vec::Vec<descriptor_proto::ExtensionRange>,
    #[bilrost(message, repeated, tag = "8")]
    pub oneof_decl: ::bilrost::alloc::vec::Vec<OneofDescriptorProto>,
    #[bilrost(message, optional, tag = "7")]
    pub options: ::core::option::Option<MessageOptions>,
    #[bilrost(message, repeated, tag = "9")]
    pub reserved_range: ::bilrost::alloc::vec::Vec<descriptor_proto::ReservedRange>,
    /// Reserved field names, which may not be used by fields in the same message.
    /// A given name may only be reserved once.
    #[bilrost(string, repeated, tag = "10")]
    pub reserved_name: ::bilrost::alloc::vec::Vec<::bilrost::alloc::string::String>,
}
...
pub mod descriptor_proto {
    ...
    pub struct ExtensionRange {
        /// Inclusive.
        #[bilrost(int32, optional, tag = "1")]
        pub start: ::core::option::Option<i32>,
        /// Exclusive.
        #[bilrost(int32, optional, tag = "2")]
        pub end: ::core::option::Option<i32>,
        #[bilrost(message, optional, tag = "3")]
...
pub struct ExtensionRangeOptions {
    ...
    #[bilrost(message, repeated, tag = "999")]
    pub uninterpreted_option: ::bilrost::alloc::vec::Vec<UninterpretedOption>,
}
...
pub struct FieldDescriptorProto {
    #[bilrost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(int32, optional, tag = "3")]
    pub number: ::core::option::Option<i32>,
    #[bilrost(enumeration = "field_descriptor_proto::Label", optional, tag = "4")]
    pub label: ::core::option::Option<i32>,
    /// If type_name is set, this need not be set.  If both this and type_name
    /// are set, this must be one of TYPE_ENUM, TYPE_MESSAGE or TYPE_GROUP.
    #[bilrost(enumeration = "field_descriptor_proto::Type", optional, tag = "5")]
    ...
    /// namespace).
    #[bilrost(string, optional, tag = "6")]
    pub type_name: ::core::option::Option<::bilrost::alloc::string::String>,
    /// For extensions, this is the name of the type being extended.  It is
    /// resolved in the same manner as type_name.
    #[bilrost(string, optional, tag = "2")]
    pub extendee: ::core::option::Option<::bilrost::alloc::string::String>,
    /// For numeric types, contains the original text representation of the value.
    /// For booleans, "true" or "false".
    /// For strings, contains the default text contents (not escaped in any way).
    /// For bytes, contains the C escaped value.  All bytes >= 128 are escaped.
    /// TODO(kenton):  Base-64 encode?
    #[bilrost(string, optional, tag = "7")]
    pub default_value: ::core::option::Option<::bilrost::alloc::string::String>,
    /// If set, gives the index of a oneof in the containing type's oneof_decl
    /// list.  This field is a member of that oneof.
    #[bilrost(int32, optional, tag = "9")]
    pub oneof_index: ::core::option::Option<i32>,
    /// JSON name of this field. The value is set by protocol compiler. If the
    /// user has set a "json_name" option on this field, that option's value
    /// will be used. Otherwise, it's deduced from the field's name by converting
    /// it to camelCase.
    #[bilrost(string, optional, tag = "10")]
    pub json_name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, optional, tag = "8")]
...
pub struct OneofDescriptorProto {
    #[bilrost(string, optional, tag = "1")]
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, optional, tag = "2")]
...
pub struct EnumDescriptorProto {
    ...
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, repeated, tag = "2")]
    pub value: ::bilrost::alloc::vec::Vec<EnumValueDescriptorProto>,
    #[bilrost(message, optional, tag = "3")]
    ...
    /// overlap.
    #[bilrost(message, repeated, tag = "4")]
    pub reserved_range: ::bilrost::alloc::vec::Vec<
        enum_descriptor_proto::EnumReservedRange,
    >,
    /// Reserved enum value names, which may not be reused. A given name may only
    /// be reserved once.
    #[bilrost(string, repeated, tag = "5")]
    pub reserved_name: ::bilrost::alloc::vec::Vec<::bilrost::alloc::string::String>,
}
...
pub struct ServiceDescriptorProto {
    ...
    pub name: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, repeated, tag = "2")]
    pub method: ::bilrost::alloc::vec::Vec<MethodDescriptorProto>,
    #[bilrost(message, optional, tag = "3")]
...
pub struct MethodDescriptorProto {
    ...
    #[bilrost(string, optional, tag = "2")]
    pub input_type: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(string, optional, tag = "3")]
    pub output_type: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(message, optional, tag = "4")]
    pub options: ::core::option::Option<MethodOptions>,
    /// Identifies if client streams multiple client messages
    #[bilrost(bool, optional, tag = "5", default = "false")]
    pub client_streaming: ::core::option::Option<bool>,
    /// Identifies if server streams multiple server messages
    #[bilrost(bool, optional, tag = "6", default = "false")]
...
pub struct FileOptions {
    ...
    /// domain names.
    #[bilrost(string, optional, tag = "1")]
    pub java_package: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Controls the name of the wrapper Java class generated for the .proto file.
    /// That class will always contain the .proto file's getDescriptor() method as
    /// well as any top-level extensions defined in the .proto file.
    /// If java_multiple_files is disabled, then all the other classes from the
    /// .proto file will be nested inside the single wrapper outer class.
    #[bilrost(string, optional, tag = "8")]
    pub java_outer_classname: ::core::option::Option<::bilrost::alloc::string::String>,
    ...
    #[bilrost(bool, optional, tag = "10", default = "false")]
    pub java_multiple_files: ::core::option::Option<bool>,
    /// This option does nothing.
    #[deprecated]
    #[bilrost(bool, optional, tag = "20")]
    ...
    #[bilrost(bool, optional, tag = "27", default = "false")]
    ...
    #[bilrost(string, optional, tag = "11")]
    pub go_package: ::core::option::Option<::bilrost::alloc::string::String>,
    ...
    #[bilrost(bool, optional, tag = "16", default = "false")]
    pub cc_generic_services: ::core::option::Option<bool>,
    #[bilrost(bool, optional, tag = "17", default = "false")]
    pub java_generic_services: ::core::option::Option<bool>,
    #[bilrost(bool, optional, tag = "18", default = "false")]
    pub py_generic_services: ::core::option::Option<bool>,
    #[bilrost(bool, optional, tag = "42", default = "false")]
    pub php_generic_services: ::core::option::Option<bool>,
    /// Is this file deprecated?
    /// Depending on the target platform, this can emit Deprecated annotations
    /// for everything in the file, or it will be completely ignored; in the very
    /// least, this is a formalization for deprecating files.
    #[bilrost(bool, optional, tag = "23", default = "false")]
    pub deprecated: ::core::option::Option<bool>,
    /// Enables the use of arenas for the proto messages in this file. This applies
    /// only to generated classes for C++.
    #[bilrost(bool, optional, tag = "31", default = "true")]
    pub cc_enable_arenas: ::core::option::Option<bool>,
    /// Sets the objective c class prefix which is prepended to all objective c
    /// generated classes from this .proto. There is no default.
    #[bilrost(string, optional, tag = "36")]
    pub objc_class_prefix: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Namespace for generated classes; defaults to the package.
    #[bilrost(string, optional, tag = "37")]
    pub csharp_namespace: ::core::option::Option<::bilrost::alloc::string::String>,
    /// By default Swift generators will take the proto package and CamelCase it
    /// replacing '.' with underscore and use that to prefix the types/symbols
    /// defined. When this options is provided, they will use this value instead
    /// to prefix the types/symbols defined.
    #[bilrost(string, optional, tag = "39")]
    pub swift_prefix: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Sets the php class prefix which is prepended to all php generated classes
    /// from this .proto. Default is empty.
    #[bilrost(string, optional, tag = "40")]
    pub php_class_prefix: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Use this option to change the namespace of php generated classes. Default
    /// is empty. When this option is empty, the package name will be used for
    /// determining the namespace.
    #[bilrost(string, optional, tag = "41")]
    pub php_namespace: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Use this option to change the namespace of php generated metadata classes.
    /// Default is empty. When this option is empty, the proto file name will be
    /// used for determining the namespace.
    #[bilrost(string, optional, tag = "44")]
    pub php_metadata_namespace: ::core::option::Option<::bilrost::alloc::string::String>,
    /// Use this option to change the package of ruby generated classes. Default
    /// is empty. When this option is not set, the package name will be used for
    /// determining the ruby package.
    #[bilrost(string, optional, tag = "45")]
    pub ruby_package: ::core::option::Option<::bilrost::alloc::string::String>,
...
pub struct ServiceOptions {
    ...
    #[bilrost(bool, optional, tag = "33", default = "false")]
    pub deprecated: ::core::option::Option<bool>,
    /// The parser stores options it doesn't recognize here. See above.
    #[bilrost(message, repeated, tag = "999")]
    pub uninterpreted_option: ::bilrost::alloc::vec::Vec<UninterpretedOption>,
...
pub struct UninterpretedOption {
    #[bilrost(message, repeated, tag = "2")]
    pub name: ::bilrost::alloc::vec::Vec<uninterpreted_option::NamePart>,
    /// The value of the uninterpreted option, in whatever type the tokenizer
    /// identified it as during parsing. Exactly one of these should be set.
    #[bilrost(string, optional, tag = "3")]
    pub identifier_value: ::core::option::Option<::bilrost::alloc::string::String>,
    #[bilrost(uint64, optional, tag = "4")]
    pub positive_int_value: ::core::option::Option<u64>,
    #[bilrost(int64, optional, tag = "5")]
    pub negative_int_value: ::core::option::Option<i64>,
    #[bilrost(double, optional, tag = "6")]
    pub double_value: ::core::option::Option<f64>,
    #[bilrost(bytes = "vec", optional, tag = "7")]
    pub string_value: ::core::option::Option<::bilrost::alloc::vec::Vec<u8>>,
    #[bilrost(string, optional, tag = "8")]
    pub aggregate_value: ::core::option::Option<::bilrost::alloc::string::String>,
}
...
pub mod uninterpreted_option {
    ...
    #[derive(Clone, PartialEq, ::bilrost::Message)]
    pub struct NamePart {
        #[bilrost(string, required, tag = "1")]
        pub name_part: ::bilrost::alloc::string::String,
        #[bilrost(bool, required, tag = "2")]
...
pub struct SourceCodeInfo {
    ...
    #[bilrost(message, repeated, tag = "1")]
    pub location: ::bilrost::alloc::vec::Vec<source_code_info::Location>,
}
...
pub mod source_code_info {
    ...
    pub struct Location {
        ...
        #[bilrost(int32, repeated, tag = "1")]
        pub path: ::bilrost::alloc::vec::Vec<i32>,
        /// Always has exactly three or four elements: start line, start column,
        /// end line (optional, otherwise assumed same as start line), end column.
        /// These are packed into a single field for efficiency.  Note that line
        /// and column numbers are zero-based -- typically you will want to add
        /// 1 to each before displaying to a user.
        #[bilrost(int32, repeated, tag = "2")]
        pub span: ::bilrost::alloc::vec::Vec<i32>,
        ...
        #[bilrost(string, optional, tag = "3")]
        pub leading_comments: ::core::option::Option<::bilrost::alloc::string::String>,
        #[bilrost(string, optional, tag = "4")]
        pub trailing_comments: ::core::option::Option<::bilrost::alloc::string::String>,
        #[bilrost(string, repeated, tag = "6")]
        pub leading_detached_comments: ::bilrost::alloc::vec::Vec<
...
pub struct GeneratedCodeInfo {
    ...
    #[bilrost(message, repeated, tag = "1")]
    pub annotation: ::bilrost::alloc::vec::Vec<generated_code_info::Annotation>,
}
...
pub mod generated_code_info {
    ...
    pub struct Annotation {
        ...
        #[bilrost(string, optional, tag = "2")]
        pub source_file: ::core::option::Option<::bilrost::alloc::string::String>,
...
pub struct SourceContext {
    ...
    #[bilrost(string, tag = "1")]
    pub file_name: ::bilrost::alloc::string::String,
}
...
pub struct Type {
    ...
    /// The list of fields.
    #[bilrost(message, repeated, tag = "2")]
    pub fields: ::bilrost::alloc::vec::Vec<Field>,
    /// The list of types appearing in `oneof` definitions in this type.
    #[bilrost(string, repeated, tag = "3")]
    pub oneofs: ::bilrost::alloc::vec::Vec<::bilrost::alloc::string::String>,
    /// The protocol buffer options.
    #[bilrost(message, repeated, tag = "4")]
    pub options: ::bilrost::alloc::vec::Vec<Option>,
    /// The source context.
    #[bilrost(message, optional, tag = "5")]
    pub source_context: ::core::option::Option<SourceContext>,
    /// The source syntax.
    #[bilrost(enumeration = "Syntax", tag = "6")]
    pub syntax: i32,
}
...
pub struct Field {
    /// The field type.
    #[bilrost(enumeration = "field::Kind", tag = "1")]
    pub kind: i32,
    /// The field cardinality.
    #[bilrost(enumeration = "field::Cardinality", tag = "2")]
    pub cardinality: i32,
    /// The field number.
    #[bilrost(int32, tag = "3")]
    pub number: i32,
    /// The field name.
    #[bilrost(string, tag = "4")]
    pub name: ::bilrost::alloc::string::String,
    ...
    pub options: ::bilrost::alloc::vec::Vec<Option>,
    /// The field JSON name.
    #[bilrost(string, tag = "10")]
    pub json_name: ::bilrost::alloc::string::String,
    /// The string value of the default value of this field. Proto2 syntax only.
    #[bilrost(string, tag = "11")]
    pub default_value: ::bilrost::alloc::string::String,
}
...
pub struct Enum {
    ...
    #[bilrost(message, repeated, tag = "2")]
    pub enumvalue: ::bilrost::alloc::vec::Vec<EnumValue>,
    ...
    pub source_context: ::core::option::Option<SourceContext>,
    /// The source syntax.
    #[bilrost(enumeration = "Syntax", tag = "5")]
    pub syntax: i32,
}
...
pub struct Api {
    ...
    #[bilrost(message, repeated, tag = "2")]
    pub methods: ::bilrost::alloc::vec::Vec<Method>,
    ...
    #[bilrost(string, tag = "4")]
    pub version: ::bilrost::alloc::string::String,
    ...
    #[bilrost(message, repeated, tag = "6")]
    pub mixins: ::bilrost::alloc::vec::Vec<Mixin>,
    /// The source syntax of the service.
    #[bilrost(enumeration = "Syntax", tag = "7")]
    pub syntax: i32,
}
...
pub struct Method {
    ...
    #[bilrost(string, tag = "2")]
    pub request_type_url: ::bilrost::alloc::string::String,
    /// If true, the request is streamed.
    #[bilrost(bool, tag = "3")]
    pub request_streaming: bool,
    /// The URL of the output message type.
    #[bilrost(string, tag = "4")]
    pub response_type_url: ::bilrost::alloc::string::String,
...
pub struct Mixin {
    ...
    /// are rooted.
    #[bilrost(string, tag = "2")]
    pub root: ::bilrost::alloc::string::String,
}
...
pub struct FieldMask {
    ...
    #[bilrost(string, repeated, tag = "1")]
    pub paths: ::bilrost::alloc::vec::Vec<::bilrost::alloc::string::String>,
}
