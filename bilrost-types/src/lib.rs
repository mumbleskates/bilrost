...
#[cfg(feature = "prost-types")]
impl From<StructValue> for prost_types::Struct {
...
#[cfg(feature = "prost-types")]
impl From<prost_types::Struct> for StructValue {
...
#[cfg(feature = "prost-types")]
impl From<ListValue> for prost_types::ListValue {
    ...
    fn from(value: Value) -> Self {
        prost_types::Value {
            kind: Some(match value.kind {
                ...
                value::Kind::List(values) => prost_types::value::Kind::ListValue(values.into()),
            }),
        }
    }
}
    ...
    fn from(value: prost_types::Value) -> Self {
        Value {
            kind: match value.kind {
                None | Some(prost_types::value::Kind::NullValue(_)) => value::Kind::Null,
                Some(prost_types::value::Kind::NumberValue(value)) => value::Kind::Float(value),
                Some(prost_types::value::Kind::StringValue(value)) => value::Kind::String(value),
                Some(prost_types::value::Kind::BoolValue(value)) => value::Kind::Bool(value),
                Some(prost_types::value::Kind::StructValue(items)) => {
                    value::Kind::Struct(items.into())
                }
                Some(prost_types::value::Kind::ListValue(values)) => {
                    value::Kind::List(values.into())
                }
            },
        }
    }
